...
const body = new URLSearchParams({
  ...
  linkname: 'SPRAVS - Phone Charger Reviews and Charging Guides',
  linkurl: 'https://spravs.com',
  descriere: 'SPRAVS reviews phone chargers, cables, GaN adapters and wireless charging pads with real-world speed tests. Practical guides cover fast-charge standards, power bank picks and battery health tips.',
  email: 'df.spr@92ng.com',
  txtNumber: '4952',
  Submit: 'Add URL',
});
