...
const body = new URLSearchParams({
  ...
  cat1: '/computers/', cat2: '', cat3: '', seluri: '', act: 'send',
  load: (Math.random() * 2.9 + 9.05).toString(),
...
for (const kw of [/thank/i, /submitted/i, /success/i, /added/i, /received/i, /error[^s]/i, /invalid/i, /required/i, /already/i, /will be/i, /moderat/i, /queue/i, /review/i]) {
