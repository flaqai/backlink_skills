...
const body = new URLSearchParams({
  url: 'https://zakaihu.com',
  email: 'sr.zak@92ng.com',
  name: 'ZA Bank Account Opening Guide for Hong Kong Arrivals',
  terms: 'on',
});
const res = await fetch('https://www.sonicrun.com/cgi-bin/add.cgi', { method: 'POST', headers: { ...H, 'Content-Type': 'application/x-www-form-urlencoded', Referer: 'https://www.sonicrun.com/freelisting.html' }, body: body.toString(), redirect: 'follow' });
...
for (const kw of [/thank/i, /submitted/i, /success/i, /added/i, /received/i, /review/i, /error/i, /invalid/i, /already/i, /queue/i, /approv/i]) {
