...
try {
  ...
  const VALUES = ['Leo Xm', 'once.shark@92ng.com', 'Crazy Shark', 'https://crazyshark.org/', 'Free shark attack browser game with fast-paced arcade action.', 'Play Crazy Shark, a free shark attack browser game. Fast-paced arcade survival action with quick matches, no downloads, instant fun.', 'Free'];
