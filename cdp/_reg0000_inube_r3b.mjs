...
for (const [x,y] of [[615,400],[518,496],[615,496],[712,496],[809,400]]) await click(x,y);
const s = await c.send('Page.captureScreenshot', {format:'png'}).catch(()=>null);
if(s) writeFileSync('D:/Github/seoadminC/storage/_reg0000/inube_r3_sel.png', Buffer.from(s.data,'base64'));
console.log('sel+shot');
