...
for (const [x,y] of [[712,400],[712,496],[809,496],[712,592],[809,592]]) await click(x,y);
await click(794,679); // 下一个/验证
await sleep(3000);
...
if (tk.indexOf('NONE') >= 0) {
  ...
  if(s) writeFileSync('D:/Github/seoadminC/storage/_reg0000/inube_f2.jpg', Buffer.from(s.data,'base64'));
  console.log('shot2');
}
