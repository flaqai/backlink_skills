...
for (const [x,y] of [[518,400],[615,400],[518,496],[615,496]]) await click(x,y);
await click(794,679);
await sleep(3000);
...
if (tk.indexOf('HAS') >= 0) {
  ...
  if(s) writeFileSync('D:/Github/seoadminC/storage/_reg0000/inube_f7.jpg', Buffer.from(s.data,'base64'));
  console.log('shot7');
}
