...
if (!tab) { console.log('no letterpad tab'); process.exit(1); }
...
await c.send('Page.navigate', { url: 'https://letterpad.app/update/site-info' });
await sleep(6000);
...
if (shot) fs.writeFileSync('D:/Github/seoadminC/storage/_reg0000/lp_siteinfo.png', Buffer.from(shot.data, 'base64'));
console.log('SHOT ok');
